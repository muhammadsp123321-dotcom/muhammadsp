...
const topRow = [
  { name: "After Effects", icon: <FaFilm size={70} color="#9999FF" /> },
  { name: "Premiere Pro", icon: <FaVideo size={70} color="#9999FF" /> },
  { name: "Blender", icon: <SiBlender size={70} color="#F5792A" /> },
];
...
export default function ToolsSection() {
  return (
    <section className="bg-[#0C0C0C] py-28 overflow-hidden">

      <h2 className="text-center text-white text-6xl font-black uppercase mb-4">
        Creative Toolkit
      </h2>
